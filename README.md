...
| Boards | Where | Status |
| --- | --- | --- |
| 89 ESP32-family boards, including colour-touchscreen boards with the OSHI screen interface (Heltec, LILYGO, RAK, Seeed, Elecrow, B&Q, M5Stack...) | [web flasher](https://oshi-messenger.com/lora/flash/) | released, built by public CI for every board |
